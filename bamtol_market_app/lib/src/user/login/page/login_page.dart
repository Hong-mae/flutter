...
class LoginPage extends GetView<LoginController> {
  ...
  Widget _textDivider() {
    return const Padding(
        padding: EdgeInsetsGeometry.symmetric(horizontal: 80.0),
        child: Row(
          children: [
            Expanded(child: Divider(color: Colors.white,)),
            Padding(
              padding: EdgeInsets.symmetric(vertical: 50.0, horizontal: 20),
              child: AppFont(text: "회원 가입 / 로그인", color: Colors.white,),
            ),
            Expanded(child: Divider(color: Colors.white,))
          ],
        )
          ...
          Btn(
            ...
            child: Row(
              children: [
                ...
                const AppFont(text: "Google로 계속하기", color: Colors.black,)
              ],
            ),
          ),
          const SizedBox(height: 15,),
          Btn(
            ...
            child: Row(
              children: [
                ...
                const AppFont(text: "Apple로 계속하기", color: Colors.white,),
              ],
            ),
          )
        ],
